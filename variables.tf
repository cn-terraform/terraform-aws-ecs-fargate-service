...
# AWS LOAD BALANCER
#------------------------------------------------------------------------------
variable "use_custom_lb" {
  description = "If true, this module will not create a load balancer. You should set the variable additional_lbs to define load balancers to attach to the ECS service."
  type        = bool
  default     = false
}
